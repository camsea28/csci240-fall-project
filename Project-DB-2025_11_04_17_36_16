...
--
-- Table structure for table `CrewMember_Event`
--

DROP TABLE IF EXISTS `CrewMember_Event`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `CrewMember_Event` (
  `crewmember_id` int NOT NULL,
  `event_id` int NOT NULL,
  PRIMARY KEY (`crewmember_id`,`event_id`),
  KEY `idx_cme_event` (`event_id`),
  CONSTRAINT `fk_cme_crewmember` FOREIGN KEY (`crewmember_id`) REFERENCES `CrewMember` (`crewmember_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_cme_event` FOREIGN KEY (`event_id`) REFERENCES `Event` (`event_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `CrewMember_Event`
--

LOCK TABLES `CrewMember_Event` WRITE;
/*!40000 ALTER TABLE `CrewMember_Event` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `CrewMember_Event` VALUES
(1,1),
(2,1),
(1,2);
/*!40000 ALTER TABLE `CrewMember_Event` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
-- Dump completed on 2025-11-04 17:36:18
